...
This file governs work on the **`rpi-kit-codex` kit repository itself**.

## Scope

Use this file when the task is about maintaining or improving `rpi-kit-codex` (installer behavior, docs, scripts, CI, skills inventory, etc.).
...
`rpi-kit-codex/install.js` must not copy this root `AGENTS.md` into target repositories.
